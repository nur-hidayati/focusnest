...
import 'package:focusnest/src/features/settings/presentation/update_email_verify_screen.dart';
                    ...
                    routes: [
                      GoRoute(
                          ...
                          routes: [
                            GoRoute(
                              path: 'verify',
                              name: RoutesName.updateEmailVerify,
                              parentNavigatorKey: _rootNavigatorKey,
                              pageBuilder: (context, state) {
                                final userId = state.pathParameters['userId']!;
                                final userEmail =
